...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <button class="btn btn-outline-success"  v-on:click="$emit('addD', 'true')" >Add new director</button>
    </div>
  </div>
</nav>
...
<div class="movie-box">
  <div class="slider-box" v-for="director in directors">
    ...
    <button class="cart"  v-on:click="$emit('chooseDirector', {...director})">Edit </button>
